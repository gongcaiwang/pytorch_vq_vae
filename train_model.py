...
def train_model():
    ...
    run_name = 'resnet_spec_down6_unit100_106wset_0token_isolated_token_forfirstlayer'
    ...
    for i in xrange(num_training_updates):
        ...
        onstage = F.interpolate(onstage,scale_factor=1/2**folds,mode='linear')
        offstage = (onstage==0).float()
        ...
        optimizer.zero_grad()
        vq_loss, data_recon, perplexity, distance = model(data,datatypes=datatypes,offstage=offstage)
        recon_error = 0
